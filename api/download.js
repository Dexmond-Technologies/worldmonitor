...
const RELEASES_URL = 'https://api.github.com/repos/Dexmond-Technologies/worldmonitor/releases/latest';
const RELEASES_PAGE = 'https://github.com/Dexmond-Technologies/worldmonitor/releases/latest';
