    ...
    this.ctx.container.innerHTML = `
      <div class="header">
        ...
        return `
          ...
          <span class="logo"><span class="logo-dexmond">DEXMOND</span><span class="logo-tech">TECHNOLOGIES</span></span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://dexmond.com" target="_blank" rel="noopener" class="credit-link">
            <span class="credit-text">dexmond.com</span>
          </a>
          <a href="https://dexmond.com" target="_blank" rel="noopener" class="github-link" title="Dexmond Technologies Ltd.">
